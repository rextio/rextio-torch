...
from rextio_torch.claim import activations, binops, classification, cuda, gelu, linear, reductions, unary
...
def claim(site: ClaimSite, config: RextioConfig) -> ClaimResult:
    ...
    """
    del config
    for lane in (cuda, linear, gelu, activations, unary, reductions, classification, binops):
